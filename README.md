...
- **[plane_slam_demo](examples/plane_slam_demo.rs)** -- plane SLAM with a user-defined component: `UnitVec`, a 2-DOF unit direction on the sphere, demonstrating `#[arael(component)]`.
