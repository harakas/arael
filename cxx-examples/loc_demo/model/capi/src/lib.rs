...
/// Appends `n` elements built from `n` slot records of 9 u64 each (mask
...
pub unsafe extern "C" fn path_poses_push_back_n(p: *mut PathHandle, slots: *const u64, n: u32) -> u32 {
    ...
    for i in 0..n as usize {
        ...
        if !slots.is_null() {
            assign_slots_pose(&mut e, slots.add(i * 9));
        }
        m.push_back(e);
    }
...
pub unsafe extern "C" fn path_poses_set_pos_n(
    ...
    for i in 0..n {
        ...
        m[start + i].pos.value = std::mem::transmute::<[f32; 3], CVec3F32>(std::ptr::read_unaligned(src as *const [f32; 3])).into();
    }
    true
}
...
pub unsafe extern "C" fn path_poses_get_pos_n(
    ...
    for i in 0..n {
        ...
        let mv: CVec3F32 = m[start + i].pos.value.into();
        std::ptr::write_unaligned(dst as *mut [f32; 3], std::mem::transmute::<CVec3F32, [f32; 3]>(mv));
    }
    true
}
...
/// apart (0 broadcasts one value); false when the range exceeds the collection.
#[no_mangle]
pub unsafe extern "C" fn path_poses_set_ea_n(
    p: *mut PathHandle, start: u32, v: *const f32, n: u32, stride: i64) -> bool {
    let m = &mut (*p).model.poses;
    let (start, n) = (start as usize, n as usize);
    if start + n > m.len() {
    ...
    for i in 0..n {
        let src = (v as *const u8).offset((i as i64 * stride) as isize) as *const f32;
        m[start + i].ea.value = std::mem::transmute::<[f32; 3], CVec3F32>(std::ptr::read_unaligned(src as *const [f32; 3])).into();
    }
    true
}
...
/// apart; false when the range exceeds the collection.
#[no_mangle]
pub unsafe extern "C" fn path_poses_get_ea_n(
    p: *const PathHandle, start: u32, out: *mut f32, n: u32, stride: i64) -> bool {
    let m = &(*p).model.poses;
    let (start, n) = (start as usize, n as usize);
    if start + n > m.len() {
    ...
    for i in 0..n {
        let dst = (out as *mut u8).offset((i as i64 * stride) as isize) as *mut f32;
        let mv: CVec3F32 = m[start + i].ea.value.into();
        std::ptr::write_unaligned(dst as *mut [f32; 3], std::mem::transmute::<CVec3F32, [f32; 3]>(mv));
    }
    true
}
...
/// apart (0 broadcasts one value); false when the range exceeds the collection.
#[no_mangle]
pub unsafe extern "C" fn path_poses_set_ea_optimize_n(
    p: *mut PathHandle, start: u32, v: *const u8, n: u32, stride: i64) -> bool {
    let m = &mut (*p).model.poses;
    let (start, n) = (start as usize, n as usize);
    if start + n > m.len() {
...
/// apart; false when the range exceeds the collection.
#[no_mangle]
pub unsafe extern "C" fn path_poses_get_ea_optimize_n(
    p: *const PathHandle, start: u32, out: *mut u8, n: u32, stride: i64) -> bool {
    let m = &(*p).model.poses;
    let (start, n) = (start as usize, n as usize);
    if start + n > m.len() {
...
pub unsafe extern "C" fn path_landmarks_push_n(p: *mut PathHandle, slots: *const u64, n: u32) -> u32 {
    ...
    for i in 0..n as usize {
        ...
        if !slots.is_null() {
            assign_slots_point_landmark(&mut e, slots.add(i * 4));
        }
        let r = m.push(e);
        if i == 0 {
            first = r.to_raw();
...
#[no_mangle]
pub unsafe extern "C" fn path_gamma(p: *const PathHandle) -> f32 {
    (*p).model.gamma
}
#[no_mangle]
pub unsafe extern "C" fn path_set_gamma(p: *mut PathHandle, v: f32) {
    (*p).model.gamma = v;
}
#[no_mangle]
pub unsafe extern "C" fn path_drift_pos_isigma(p: *const PathHandle) -> f32 {
    (*p).model.drift_pos_isigma
}
#[no_mangle]
pub unsafe extern "C" fn path_set_drift_pos_isigma(p: *mut PathHandle, v: f32) {
    (*p).model.drift_pos_isigma = v;
}
#[no_mangle]
pub unsafe extern "C" fn path_drift_ea_isigma(p: *const PathHandle) -> f32 {
    (*p).model.drift_ea_isigma
}
#[no_mangle]
pub unsafe extern "C" fn path_set_drift_ea_isigma(p: *mut PathHandle, v: f32) {
    (*p).model.drift_ea_isigma = v;
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn path_point_landmark_pos(p: *const PointLandmark) -> CVec3F32 {
    (*p).pos.into()
}
#[no_mangle]
pub unsafe extern "C" fn path_point_landmark_set_pos(p: *mut PointLandmark, v: CVec3F32) {
    (*p).pos = v.into();
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn path_pose_pos(p: *const Pose) -> CVec3F32 {
    (*p).pos.value.into()
}
#[no_mangle]
pub unsafe extern "C" fn path_pose_set_pos(p: *mut Pose, v: CVec3F32) {
    (*p).pos.value = v.into();
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn path_pose_ea(p: *const Pose) -> CVec3F32 {
    (*p).ea.value.into()
}
#[no_mangle]
pub unsafe extern "C" fn path_pose_set_ea(p: *mut Pose, v: CVec3F32) {
    (*p).ea.value = v.into();
}
#[no_mangle]
pub unsafe extern "C" fn path_pose_ea_optimize(p: *const Pose) -> bool {
    (*p).ea.optimize
}
#[no_mangle]
pub unsafe extern "C" fn path_pose_ea_set_optimize(p: *mut Pose, v: bool) {
    (*p).ea.optimize = v;
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn path_pose_info_delta_ea(p: *const PoseInfo) -> CVec3F32 {
    (*p).delta_ea.into()
}
#[no_mangle]
pub unsafe extern "C" fn path_pose_info_set_delta_ea(p: *mut PoseInfo, v: CVec3F32) {
    (*p).delta_ea = v.into();
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn path_pose_info_delta_ea_cov_r(p: *const PoseInfo) -> CMat3F32 {
    (*p).delta_ea_cov_r.into()
}
#[no_mangle]
pub unsafe extern "C" fn path_pose_info_set_delta_ea_cov_r(p: *mut PoseInfo, v: CMat3F32) {
    (*p).delta_ea_cov_r = v.into();
}
#[no_mangle]
pub unsafe extern "C" fn path_pose_info_delta_ea_cov_isigma(p: *const PoseInfo) -> CVec3F32 {
    (*p).delta_ea_cov_isigma.into()
}
#[no_mangle]
pub unsafe extern "C" fn path_pose_info_set_delta_ea_cov_isigma(p: *mut PoseInfo, v: CVec3F32) {
    (*p).delta_ea_cov_isigma = v.into();
}
#[no_mangle]
pub unsafe extern "C" fn path_pose_info_tilt_roll(p: *const PoseInfo) -> f32 {
    (*p).tilt_roll
}
#[no_mangle]
pub unsafe extern "C" fn path_pose_info_set_tilt_roll(p: *mut PoseInfo, v: f32) {
    (*p).tilt_roll = v;
}
#[no_mangle]
pub unsafe extern "C" fn path_pose_info_tilt_pitch(p: *const PoseInfo) -> f32 {
    (*p).tilt_pitch
}
#[no_mangle]
pub unsafe extern "C" fn path_pose_info_set_tilt_pitch(p: *mut PoseInfo, v: f32) {
    (*p).tilt_pitch = v;
}
#[no_mangle]
...
pub unsafe extern "C" fn path_pose_info_features_set_pixel_n(
    p: *mut PoseInfo, start: u32, v: *const f32, n: u32, stride: i64) -> bool {
    let m = &mut (*p).features;
    let (start, n) = (start as usize, n as usize);
    if start + n > m.len() {
        return false;
    ...
    for i in 0..n {
        let src = (v as *const u8).offset((i as i64 * stride) as isize) as *const f32;
        m[start + i].pixel = std::mem::transmute::<[f32; 2], CVec2F32>(std::ptr::read_unaligned(src as *const [f32; 2])).into();
    }
    true
}
...
pub unsafe extern "C" fn path_pose_info_features_get_pixel_n(
    p: *const PoseInfo, start: u32, out: *mut f32, n: u32, stride: i64) -> bool {
    let m = &(*p).features;
    let (start, n) = (start as usize, n as usize);
    if start + n > m.len() {
        return false;
    ...
    for i in 0..n {
        let dst = (out as *mut u8).offset((i as i64 * stride) as isize) as *mut f32;
        let mv: CVec2F32 = m[start + i].pixel.into();
...
pub unsafe extern "C" fn path_pose_info_features_set_mf2r_n(
    ...
    for i in 0..n {
        let src = (v as *const u8).offset((i as i64 * stride) as isize) as *const f32;
        m[start + i].mf2r = std::mem::transmute::<[f32; 9], CMat3F32>(std::ptr::read_unaligned(src as *const [f32; 9])).into();
    }
    true
}
...
pub unsafe extern "C" fn path_pose_info_features_get_mf2r_n(
    ...
    for i in 0..n {
        let dst = (out as *mut u8).offset((i as i64 * stride) as isize) as *mut f32;
        let mv: CMat3F32 = m[start + i].mf2r.into();
        std::ptr::write_unaligned(dst as *mut [f32; 9], std::mem::transmute::<CMat3F32, [f32; 9]>(mv));
    }
    true
}
...
pub unsafe extern "C" fn path_pose_info_features_set_camera_pos_n(
    ...
    for i in 0..n {
        let src = (v as *const u8).offset((i as i64 * stride) as isize) as *const f32;
        m[start + i].camera_pos = std::mem::transmute::<[f32; 3], CVec3F32>(std::ptr::read_unaligned(src as *const [f32; 3])).into();
    }
    true
}
...
pub unsafe extern "C" fn path_pose_info_features_get_camera_pos_n(
    ...
    for i in 0..n {
        let dst = (out as *mut u8).offset((i as i64 * stride) as isize) as *mut f32;
        let mv: CVec3F32 = m[start + i].camera_pos.into();
        std::ptr::write_unaligned(dst as *mut [f32; 3], std::mem::transmute::<CVec3F32, [f32; 3]>(mv));
    }
    true
}
...
pub unsafe extern "C" fn path_pose_info_features_set_isigma_n(
    ...
    for i in 0..n {
        let src = (v as *const u8).offset((i as i64 * stride) as isize) as *const f32;
        m[start + i].isigma = std::mem::transmute::<[f32; 2], CVec2F32>(std::ptr::read_unaligned(src as *const [f32; 2])).into();
    }
    true
}
...
pub unsafe extern "C" fn path_pose_info_features_get_isigma_n(
    ...
    for i in 0..n {
        let dst = (out as *mut u8).offset((i as i64 * stride) as isize) as *mut f32;
        let mv: CVec2F32 = m[start + i].isigma.into();
        std::ptr::write_unaligned(dst as *mut [f32; 2], std::mem::transmute::<CVec2F32, [f32; 2]>(mv));
    }
    true
}
...
unsafe fn assign_slots_point_feature(e: &mut PointFeature, s: *const u64) {
    if *s.add(0) & (1u64 << 0) != 0 {
        e.pixel = std::mem::transmute::<[f32; 2], CVec2F32>([f64::from_bits(*s.add(1)) as f32, f64::from_bits(*s.add(2)) as f32]).into();
    }
    if *s.add(0) & (1u64 << 1) != 0 {
        e.mf2r = std::mem::transmute::<[f32; 9], CMat3F32>([f64::from_bits(*s.add(3)) as f32, f64::from_bits(*s.add(4)) as f32, f64::from_bits(*s.add(5)) as f32, f64::from_bits(*s.add(6)) as f32, f64::from_bits(*s.add(7)) as f32, f64::from_bits(*s.add(8)) as f32, f64::from_bits(*s.add(9)) as f32, f64::from_bits(*s.add(10)) as f32, f64::from_bits(*s.add(11)) as f32]).into();
    }
    if *s.add(0) & (1u64 << 2) != 0 {
        e.camera_pos = std::mem::transmute::<[f32; 3], CVec3F32>([f64::from_bits(*s.add(12)) as f32, f64::from_bits(*s.add(13)) as f32, f64::from_bits(*s.add(14)) as f32]).into();
    }
    if *s.add(0) & (1u64 << 3) != 0 {
        e.isigma = std::mem::transmute::<[f32; 2], CVec2F32>([f64::from_bits(*s.add(15)) as f32, f64::from_bits(*s.add(16)) as f32]).into();
    }
}
...
unsafe fn assign_slots_point_landmark(e: &mut PointLandmark, s: *const u64) {
    if *s.add(0) & (1u64 << 0) != 0 {
        e.pos = std::mem::transmute::<[f32; 3], CVec3F32>([f64::from_bits(*s.add(1)) as f32, f64::from_bits(*s.add(2)) as f32, f64::from_bits(*s.add(3)) as f32]).into();
    }
}

/// Assigns a slot record's masked leaves onto a `Pose`: 1 mask
/// word(s), then 8 slot(s), one per leaf in field order.
#[allow(dead_code)]
unsafe fn assign_slots_pose(e: &mut Pose, s: *const u64) {
    if *s.add(0) & (1u64 << 0) != 0 {
        e.pos.value = std::mem::transmute::<[f32; 3], CVec3F32>([f64::from_bits(*s.add(1)) as f32, f64::from_bits(*s.add(2)) as f32, f64::from_bits(*s.add(3)) as f32]).into();
    }
    if *s.add(0) & (1u64 << 1) != 0 {
        e.pos.optimize = *s.add(4) != 0;
    }
    if *s.add(0) & (1u64 << 2) != 0 {
        e.ea.value = std::mem::transmute::<[f32; 3], CVec3F32>([f64::from_bits(*s.add(5)) as f32, f64::from_bits(*s.add(6)) as f32, f64::from_bits(*s.add(7)) as f32]).into();
    }
    if *s.add(0) & (1u64 << 3) != 0 {
        e.ea.optimize = *s.add(8) != 0;
    }
}

/// Assigns a slot record's masked leaves onto a `PoseInfo`: 1 mask
/// word(s), then 32 slot(s), one per leaf in field order.
#[allow(dead_code)]
unsafe fn assign_slots_pose_info(e: &mut PoseInfo, s: *const u64) {
    if *s.add(0) & (1u64 << 0) != 0 {
        e.delta_pos = std::mem::transmute::<[f32; 3], CVec3F32>([f64::from_bits(*s.add(1)) as f32, f64::from_bits(*s.add(2)) as f32, f64::from_bits(*s.add(3)) as f32]).into();
    }
    if *s.add(0) & (1u64 << 1) != 0 {
        e.delta_ea = std::mem::transmute::<[f32; 3], CVec3F32>([f64::from_bits(*s.add(4)) as f32, f64::from_bits(*s.add(5)) as f32, f64::from_bits(*s.add(6)) as f32]).into();
    }
    if *s.add(0) & (1u64 << 2) != 0 {
        e.delta_pos_cov_r = std::mem::transmute::<[f32; 9], CMat3F32>([f64::from_bits(*s.add(7)) as f32, f64::from_bits(*s.add(8)) as f32, f64::from_bits(*s.add(9)) as f32, f64::from_bits(*s.add(10)) as f32, f64::from_bits(*s.add(11)) as f32, f64::from_bits(*s.add(12)) as f32, f64::from_bits(*s.add(13)) as f32, f64::from_bits(*s.add(14)) as f32, f64::from_bits(*s.add(15)) as f32]).into();
    }
    if *s.add(0) & (1u64 << 3) != 0 {
        e.delta_pos_cov_isigma = std::mem::transmute::<[f32; 3], CVec3F32>([f64::from_bits(*s.add(16)) as f32, f64::from_bits(*s.add(17)) as f32, f64::from_bits(*s.add(18)) as f32]).into();
    }
    if *s.add(0) & (1u64 << 4) != 0 {
        e.delta_ea_cov_r = std::mem::transmute::<[f32; 9], CMat3F32>([f64::from_bits(*s.add(19)) as f32, f64::from_bits(*s.add(20)) as f32, f64::from_bits(*s.add(21)) as f32, f64::from_bits(*s.add(22)) as f32, f64::from_bits(*s.add(23)) as f32, f64::from_bits(*s.add(24)) as f32, f64::from_bits(*s.add(25)) as f32, f64::from_bits(*s.add(26)) as f32, f64::from_bits(*s.add(27)) as f32]).into();
    }
    if *s.add(0) & (1u64 << 5) != 0 {
        e.delta_ea_cov_isigma = std::mem::transmute::<[f32; 3], CVec3F32>([f64::from_bits(*s.add(28)) as f32, f64::from_bits(*s.add(29)) as f32, f64::from_bits(*s.add(30)) as f32]).into();
    }
    if *s.add(0) & (1u64 << 6) != 0 {
        e.tilt_roll = f64::from_bits(*s.add(31)) as f32;
    }
    if *s.add(0) & (1u64 << 7) != 0 {
        e.tilt_pitch = f64::from_bits(*s.add(32)) as f32;
    }
}
