...
#[no_mangle]
pub unsafe extern "C" fn graph_cov_plan(c: *const GraphCov, out: *mut CCovPlan) {
    let p = (&*c).cov.plan();
    *out = CCovPlan {
        ordering: match p.ordering {
...
pub unsafe extern "C" fn graph_assemble_covariance(h: *mut GraphHandle, mode: u32, out: *mut *mut GraphCov) -> i32 {
    graph_assemble_covariance_with(h, mode, 0, 0, out)
}

/// graph_assemble_covariance with the assembly spelled out.
/// ordering: 0 = Auto, 1 = Amd, 2 = NestedDissection, 3 = Natural.
/// block_supernodal: 0 = Auto, 1 = Always, 2 = Never.
#[no_mangle]
pub unsafe extern "C" fn graph_assemble_covariance_with(
    h: *mut GraphHandle, mode: u32, ordering: u32, block_supernodal: u32,
    out: *mut *mut GraphCov,
) -> i32 {
    let hh = &mut *h;
