...
PANELS = [
    ("60 poses, 1,080 params -- Apple M4 Pro", 1, (18.0, 6.0), [
        ("arael (f32)", 1.34, 1.87, "arael"),
        ("arael (f64)", 1.84, 2.19, "arael"),
        ("g2o (LM)", 3.54, 6.89, "other"),
        ("Ceres (LM)", 5.31, 10.63, "other"),
        ("SymForce (f64)", 5.63, 15.00, "other"),
        ("factrs (LM)", 9.11, 14.09, "other"),
        ("GTSAM (LM)", 9.69, 11.37, "other"),
    ]),
