...
PANELS = [
    ("60 poses, 1,080 params -- Apple M4 Pro", 1, (18.0, 6.0), [
        ("arael (f32)", 1.73, 2.41, "arael"),
        ("arael (f64)", 2.12, 2.80, "arael"),
        ("g2o (LM)", 3.35, 7.12, "other"),
        ("Ceres (LM)", 5.13, 10.73, "other"),
        ("SymForce (f64)", 5.96, 15.03, "other"),
        ("factrs (LM)", 8.79, 14.38, "other"),
        ("GTSAM (LM)", 9.80, 11.60, "other"),
    ]),
    ...
    ("60 poses, 1,080 params -- Raspberry Pi 5", 1, (64.0, 16.0), [
        ("arael (f32)", 7.56, 10.50, "arael"),
        ("arael (f64)", 9.86, 13.68, "arael"),
        ("g2o (LM)", 16.40, 29.63, "other"),
        ("SymForce (f64)", 17.61, 53.09, "other"),
        ("Ceres (LM)", 24.72, 43.58, "other"),
        ("factrs (LM)", 35.11, 55.67, "other"),
        ("GTSAM (LM)", 44.43, 50.66, "other"),
    ]),
    ("60 poses, 1,080 params -- Raspberry Pi Zero W (ARMv6)", 1, (2000.0, 500.0), [
        ("arael (f32)", 242.45, 305.99, "arael"),
        ("arael (f64)", 368.06, 427.77, "arael"),
        ("factrs (LM)", 1258.46, 1554.32, "other"),
    ]),
]
