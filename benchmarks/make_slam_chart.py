...
PANELS = [
    ("60 poses, 1,080 params -- Apple M4 Pro", 1, (18.0, 6.0), [
        ("arael (f32)", 1.47, 2.12, "arael"),
        ("arael (f64)", 1.78, 2.51, "arael"),
        ("g2o (LM)", 3.42, 6.78, "other"),
        ("Ceres (LM)", 5.22, 10.39, "other"),
        ("SymForce (f64)", 5.51, 14.56, "other"),
        ("factrs (LM)", 8.19, 13.39, "other"),
        ("GTSAM (LM)", 9.02, 11.18, "other"),
    ]),
