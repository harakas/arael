...
# is the setup, drawn faded. 2026-07-20, min of 128 rounds (64 at 900 poses).
...
PANELS = [
    ("60 poses, 24 planes (492 params)", [
        ("arael (f32)", 0.11, 0.32, "arael"),
        ("arael (f64)", 0.13, 0.34, "arael"),
        ("SymForce (f32)", 0.15, 0.91, "other"),
        ("SymForce (f64)", 0.19, 0.92, "other"),
        ("Ceres", 0.38, 0.88, "other"),
        ("GTSAM", 0.56, 0.65, "other"),
        ("factrs", 0.77, 1.34, "other"),
        ("g2o", 1.04, 1.13, "other"),
    ]),
    ("120 poses, 45 planes (975 params)", [
        ("arael (f32)", 0.23, 0.86, "arael"),
        ("arael (f64)", 0.27, 0.89, "arael"),
        ("SymForce (f32)", 0.32, 1.79, "other"),
        ("SymForce (f64)", 0.43, 1.78, "other"),
        ("Ceres", 0.78, 1.75, "other"),
        ("GTSAM", 1.19, 1.28, "other"),
        ("factrs", 1.49, 2.76, "other"),
        ("g2o", 2.02, 2.17, "other"),
    ]),
    ("300 poses, 114 planes (2442 params)", [
        ("arael (f32)", 0.61, 2.23, "arael"),
        ("arael (f64)", 0.69, 2.32, "arael"),
        ("SymForce (f32)", 0.97, 4.73, "other"),
        ("SymForce (f64)", 1.16, 4.74, "other"),
        ("Ceres", 2.1, 4.54, "other"),
        ("GTSAM", 3.02, 3.33, "other"),
        ("factrs", 4.02, 7.23, "other"),
        ("g2o", 5.27, 5.54, "other"),
    ]),
    ("900 poses, 339 planes (7317 params)", [
        ("arael (f32)", 2.1, 6.78, "arael*"),
        ("arael (f64)", 2.23, 7.42, "arael"),
        ("SymForce (f32)", 3.12, 15.62, "other"),
        ("SymForce (f64)", 3.71, 15.86, "other"),
        ("Ceres", 6.7, 14.36, "other"),
        ("GTSAM", 9.02, 56.8, "other"),
        ("g2o", 16.12, 17.08, "other"),
