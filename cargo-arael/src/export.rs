...
/// tree-relative path and what is on disk (`None` = absent).
///
...
/// output and refuses a file that does not look generated.
...
pub fn write_action(rel: &Path, on_disk: Option<&str>) -> WriteAction {
...
pub fn run_export(dir: &Path, root: Option<&str>) -> Result<(), String> {
    ...
    for (rel, content) in &files {
        ...
        match write_action(rel, on_disk.as_deref()) {
            WriteAction::Refuse => {
                return Err(format!(
