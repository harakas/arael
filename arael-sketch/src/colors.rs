...
impl ColorScheme {
    pub fn light() -> Self {
        ColorScheme {
            ...
            line: egui::Color32::from_rgb(100, 190, 220),
            ...
            arc: egui::Color32::from_rgb(100, 190, 220),
            constraint_marker: egui::Color32::from_rgb(0, 160, 0),
            preview_line: egui::Color32::from_rgba_premultiplied(100, 190, 220, 128),
            ...
            dimension_selected: egui::Color32::from_rgb(20, 60, 140),
