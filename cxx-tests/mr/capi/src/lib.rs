...
#[no_mangle]
pub unsafe extern "C" fn decay_cov_plan(c: *const DecayCov, out: *mut CCovPlan) {
    let p = (&*c).cov.plan();
    *out = CCovPlan {
        ordering: match p.ordering {
...
pub unsafe extern "C" fn decay_assemble_covariance(h: *mut DecayHandle, mode: u32, out: *mut *mut DecayCov) -> i32 {
    decay_assemble_covariance_with(h, mode, 0, 0, out)
}

/// decay_assemble_covariance with the assembly spelled out.
/// ordering: 0 = Auto, 1 = Amd, 2 = NestedDissection, 3 = Natural.
/// block_supernodal: 0 = Auto, 1 = Always, 2 = Never.
#[no_mangle]
pub unsafe extern "C" fn decay_assemble_covariance_with(
    h: *mut DecayHandle, mode: u32, ordering: u32, block_supernodal: u32,
    out: *mut *mut DecayCov,
) -> i32 {
    let hh = &mut *h;
...
/// What the assembly decided. Always succeeds -- every assembly has a plan.
#[no_mangle]
pub unsafe extern "C" fn line_cov_plan(c: *const LineCov, out: *mut CCovPlan) {
    let p = (&*c).cov.plan();
    *out = CCovPlan {
        ordering: match p.ordering {
            arael::covariance::CovOrdering::Auto => 0,
...
pub unsafe extern "C" fn line_assemble_covariance(h: *mut LineHandle, mode: u32, out: *mut *mut LineCov) -> i32 {
    line_assemble_covariance_with(h, mode, 0, 0, out)
}

/// line_assemble_covariance with the assembly spelled out.
/// ordering: 0 = Auto, 1 = Amd, 2 = NestedDissection, 3 = Natural.
/// block_supernodal: 0 = Auto, 1 = Always, 2 = Never.
#[no_mangle]
pub unsafe extern "C" fn line_assemble_covariance_with(
    h: *mut LineHandle, mode: u32, ordering: u32, block_supernodal: u32,
    out: *mut *mut LineCov,
) -> i32 {
    let hh = &mut *h;
    *out = std::ptr::null_mut();
