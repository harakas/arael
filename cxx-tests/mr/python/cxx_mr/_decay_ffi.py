...
SIGS = [
    ...
    ("decay_assemble_covariance", [ctypes.c_void_p, ctypes.c_uint32, ctypes.POINTER(ctypes.c_void_p)], ctypes.c_int32),
    ...
    ("decay_session_new", [ctypes.POINTER(_solver.SparseOptions)], ctypes.c_void_p),
    ("decay_session_free", [ctypes.c_void_p], None),
    ("decay_session_invalidate", [ctypes.c_void_p], None),
    ("decay_session_solve", [ctypes.c_void_p, ctypes.c_void_p, ctypes.POINTER(LmConfigRaw), ctypes.POINTER(LmResultRaw)], ctypes.c_int32),
